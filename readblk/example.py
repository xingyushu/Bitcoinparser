...
btcdir='/home/fish/bds-btc/data/blocks' # change this to the folder where blk0001.dat is located

blk0001=blkreader.blkfile(btcdir+'/blk00000.dat')

genesisblock=blk0001.getblock()
print(type(genesisblock))
...
for tx in genesisblock.tx:
 ...
 for txin in tx.inputs:
  ...
  print '    previous output:', str(txin.prevouthash)
